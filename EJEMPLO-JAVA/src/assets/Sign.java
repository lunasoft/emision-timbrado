...
public class Sign {
    private String getKey() {
        ...
        try {
            File file = new File("src/assets/key.key"); //path: es la ruta del archivo de llave privada
    ...
    public  String getCadena(String xml) {
        ...
        try {
            ...
            Source xslt = new StreamSource(new File("src/assets/cadenaoriginal_3_3.xslt"));
